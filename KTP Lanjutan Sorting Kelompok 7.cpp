...
void cariKTP(KTP data[], int jumlah) {
    ...
    if (!ditemukan) {
        cout << "Data dengan NIK tersebut tidak ditemukan." << endl;
    }
}
...
void cariNama(KTP data[], int jumlah) {
    ...
    if (!ditemukan) {
        cout << "Tidak ditemukan data dengan nama tersebut." << endl;
    }
}
...
int main() {
    ...
    do {
       cout << "\n=== MENU ===\n";
        ...
        cout << "2. Cari berdasarkan NIK" << endl;
        cout << "3. Cari berdasarkan nama" << endl;
        cout << "4. Urutkan berdasarkan nama" << endl;
        cout << "5. Urutkan berdasarkan tanggal lahir" << endl;
        cout << "0. Keluar" << endl;
        cout << "Pilih menu: ";
        cin >> pilihan;
        ...
        switch (pilihan) {
            ...
            case 5:
			    ...
			    cout << "Data berhasil diurutkan berdasarkan tanggal lahir:\n";
			    for (int i = 0; i < jumlah; ++i) {
			        displayKTP(daftarKTP[i]);
			    }
    break;
