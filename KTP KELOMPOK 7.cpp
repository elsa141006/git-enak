...
void editKTP(KTP &ktp) {
    ...
    do {
        ...
        switch (pilihan) {
            ...
            case 2: cout << "Tempat Lahir baru: "; getline(cin, ktp.tempat_lahir); break;
            case 3: cout << "Tanggal Lahir baru (Contoh: 3 Januari 2023): ";
    		{
        		string tgl_input;
        		getline(cin, tgl_input);
        		ktp.tanggal_lahir = formatTanggal(tgl_input);
    		}
    		break;

            case 4: cout << "Jenis Kelamin baru: "; getline(cin, ktp.jenis_kelamin); break;
            case 5: cout << "Golongan Darah baru (A/B/AB/O): "; getline(cin, ktp.gol_darah); break;
            case 6: cout << "Alamat baru: "; getline(cin, ktp.alamat); break;
            case 7: cout << "RT/RW baru: "; getline(cin, ktp.rt_rw); break;
            case 8: cout << "Kelurahan/Desa baru: "; getline(cin, ktp.kel_desa); break;
            case 9: cout << "Kecamatan baru: "; getline(cin, ktp.kecamatan); break;
            case 10: pilihAgama(ktp.agama); break;
            case 11: cout << "Status Perkawinan baru: "; getline(cin, ktp.status_perkawinan); break;
            case 12: cout << "Pekerjaan baru: "; getline(cin, ktp.pekerjaan); break;
            case 13: cout << "Kewarganegaraan baru: "; getline(cin, ktp.kewarganegaraan); break;
            case 14: cout << "Berlaku Hingga baru: "; getline(cin, ktp.berlaku_hingga); break;
